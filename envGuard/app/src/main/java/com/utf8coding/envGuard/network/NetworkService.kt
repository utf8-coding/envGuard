...
import com.utf8coding.envGuard.data.LifeIndexData
import com.utf8coding.envGuard.data.UserData
import com.utf8coding.envGuard.network.NetWorkResponse
...
interface NetworkService {
    ...
    @POST("/Bin/getNearestBin")
    @FormUrlEncoded
    @Headers("Content-Type: application/x-www-form-urlencoded")
    fun getNearestBin(@Field("latitude") latitude: String, @Field("longitude") longitude: String): Call<NetWorkResponse<NetWorkResponse.BinList>>
}